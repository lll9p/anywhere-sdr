...
pub unsafe extern "C" fn eph2sbf(
    ...
    (*sbf.offset(1 as libc::c_int as isize))[3 as libc::c_int as usize] = (deltan as libc::c_ulong
        & 0xffff as libc::c_ulong)
        << 14 as libc::c_int
        | ((m0 >> 24 as libc::c_int) as libc::c_ulong & 0xff as libc::c_ulong) << 6 as libc::c_int;
    ...
    (*sbf.offset(2 as libc::c_int as isize))[6 as libc::c_int as usize] = (crc as libc::c_ulong
        & 0xffff as libc::c_ulong)
        << 14 as libc::c_int
        | ((aop >> 24 as libc::c_int) as libc::c_ulong & 0xff as libc::c_ulong) << 6 as libc::c_int;
    ...
    if ionoutc.vflg == 1 as libc::c_int {
        ...
        (*sbf.offset(3 as libc::c_int as isize))[3 as libc::c_int as usize] = 0 as libc::c_ulong;
        (*sbf.offset(3 as libc::c_int as isize))[4 as libc::c_int as usize] = 0 as libc::c_ulong;
        (*sbf.offset(3 as libc::c_int as isize))[5 as libc::c_int as usize] = 0 as libc::c_ulong;
        (*sbf.offset(3 as libc::c_int as isize))[6 as libc::c_int as usize] = 0 as libc::c_ulong;
        (*sbf.offset(3 as libc::c_int as isize))[7 as libc::c_int as usize] = 0 as libc::c_ulong;
        (*sbf.offset(3 as libc::c_int as isize))[8 as libc::c_int as usize] = 0 as libc::c_ulong;
        (*sbf.offset(3 as libc::c_int as isize))[9 as libc::c_int as usize] = 0 as libc::c_ulong;
    }
...
pub unsafe extern "C" fn readRinexNavAll(
    ...
    while !(fgets(str.as_mut_ptr(), 100 as libc::c_int, fp)).is_null() {
        ...
        tmp[19 as libc::c_int as usize] = 0 as libc::c_int as libc::c_char;
        replaceExpDesignator(tmp.as_mut_ptr(), 19 as libc::c_int);
        (*eph.offset(ieph as isize))[sv as usize].codeL2 = atof(tmp.as_mut_ptr()) as libc::c_int;
        strncpy(
            tmp.as_mut_ptr(),
            str.as_mut_ptr().offset(41 as libc::c_int as isize),
            19 as libc::c_int as libc::c_ulong,
        ...
        tmp[19 as libc::c_int as usize] = 0 as libc::c_int as libc::c_char;
        replaceExpDesignator(tmp.as_mut_ptr(), 19 as libc::c_int);
        (*eph.offset(ieph as isize))[sv as usize].toe.week = atof(tmp.as_mut_ptr()) as libc::c_int;
        if (fgets(str.as_mut_ptr(), 100 as libc::c_int, fp)).is_null() {
            break;
        }
        strncpy(
        ...
        tmp[19 as libc::c_int as usize] = 0 as libc::c_int as libc::c_char;
        replaceExpDesignator(tmp.as_mut_ptr(), 19 as libc::c_int);
        (*eph.offset(ieph as isize))[sv as usize].svhlth = atof(tmp.as_mut_ptr()) as libc::c_int;
        ...
        (*eph.offset(ieph as isize))[sv as usize].n = sqrt(
            3.986005e14f64
                / ((*eph.offset(ieph as isize))[sv as usize].A
                    * (*eph.offset(ieph as isize))[sv as usize].A
                    * (*eph.offset(ieph as isize))[sv as usize].A),
        ) + (*eph.offset(ieph as isize))[sv as usize]
            .deltan;
...
pub unsafe extern "C" fn ionosphericDelay(
    ...
    if (*ionoutc).vflg == 0 as libc::c_int {
        ...
        lam_i = lam_u
            + psi * sin(*azel.offset(0 as libc::c_int as isize)) / cos(phi_i * 3.1415926535898f64);
...
pub unsafe extern "C" fn computeRange(
    ...
    xrot =
        pos[0 as libc::c_int as usize] + pos[1 as libc::c_int as usize] * 7.2921151467e-5f64 * tau;
    yrot =
        pos[1 as libc::c_int as usize] - pos[0 as libc::c_int as usize] * 7.2921151467e-5f64 * tau;
...
pub unsafe extern "C" fn readUserMotionLLH(
    ...
    while numd < 3000 as libc::c_int {
            ...
            || llh[1 as libc::c_int as usize] < -180.0f64
        {
            // fprintf(
            //     stderr,
            //     b"ERROR: Invalid file format (time[s], latitude[deg], longitude[deg], height [m].\n\0"
...
pub unsafe extern "C" fn readNmeaGGA(
    ...
    while !(fgets(str.as_mut_ptr(), 100 as libc::c_int, fp)).is_null() {
        ...
        (*xyz_0.offset(numd as isize))[0 as libc::c_int as usize] = pos[0 as libc::c_int as usize];
        (*xyz_0.offset(numd as isize))[1 as libc::c_int as usize] = pos[1 as libc::c_int as usize];
        (*xyz_0.offset(numd as isize))[2 as libc::c_int as usize] = pos[2 as libc::c_int as usize];
        numd += 1;
        numd;
...
pub unsafe extern "C" fn generateNavMsg(
    ...
    while isbf < 5 as libc::c_int {
        ...
        while iwrd < 10 as libc::c_int {
            ...
            prevwrd = (*chan).dwrd[((isbf + 1 as libc::c_int) * 10 as libc::c_int + iwrd) as usize];
            iwrd += 1;
            iwrd;
        }
        isbf += 1;
            ...
            if allocatedSat[sv as usize] == -(1 as libc::c_int) {
                ...
                while i < 16 as libc::c_int {
                    if (*chan.offset(i as isize)).prn == 0 as libc::c_int {
                        ...
                        computeRange(&mut rho, *eph.offset(sv as isize), &mut ionoutc, grx, xyz_0);
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int { unsafe {
        ...
        match result {
            ...
            115 => {
                ...
                if samp_freq < 1.0e6f64 {
                    // fprintf(
                    //     stderr,
                    //     b"ERROR: Invalid sampling frequency.\n\0" as *const u8
                    //         as *const libc::c_char,
                    // );
            ...
            98 => {
                    ...
                    && data_format != 16 as libc::c_int
                {
                    // fprintf(
                    //     stderr,
                    //     b"ERROR: Invalid I/Q data format.\n\0" as *const u8 as *const libc::c_char,
                    // );
            ...
            76 => {
                ...
                if ionoutc.dn < 1 as libc::c_int && ionoutc.dn > 7 as libc::c_int {
                    // fprintf(
                    //     stderr,
                    //     b"ERROR: Invalid GPS day number\0" as *const u8 as *const libc::c_char,
                    // );
                ...
                if ionoutc.wnlsf < 0 as libc::c_int {
                    // fprintf(
                    //     stderr,
                    //     b"ERROR: Invalid GPS week number\0" as *const u8 as *const libc::c_char,
                    // );
                ...
                if ionoutc.dtlsf < -(128 as libc::c_int) && ionoutc.dtlsf > 127 as libc::c_int {
                    // fprintf(
                    //     stderr,
                    //     b"ERROR: Invalid delta leap second\0" as *const u8 as *const libc::c_char,
                    // );
            ...
            112 => {
                        ...
                        != '-' as i32
                {
                    ...
                    if fixed_gain < 1 as libc::c_int || fixed_gain > 128 as libc::c_int {
                        // fprintf(
                        //     stderr,
                        //     b"ERROR: Fixed gain must be between 1 and 128.\n\0" as *const u8
                        //         as *const libc::c_char,
                        // );
    ...
    if navfile[0 as libc::c_int as usize] as libc::c_int == 0 as libc::c_int {
        // fprintf(
        //     stderr,
        //     b"ERROR: GPS ephemeris file is not specified.\n\0" as *const u8 as *const libc::c_char,
        // );
    ...
    if staticLocationMode == 0 {
        ...
        if numd == -(1 as libc::c_int) {
            // fprintf(
            //     stderr,
            //     b"ERROR: Failed to open user motion / NMEA GGA file.\n\0" as *const u8
            //         as *const libc::c_char,
            // );
            ...
            // fprintf(
            //     stderr,
            //     b"ERROR: Failed to read user motion / NMEA GGA data.\n\0" as *const u8
            //         as *const libc::c_char,
            // );
    ...
    if neph == 0 as libc::c_int {
        // fprintf(
        //     stderr,
        //     b"ERROR: No ephemeris available.\n\0" as *const u8 as *const libc::c_char,
        // );
        ...
        // fprintf(
        //     stderr,
        //     b"ERROR: ephemeris file not found.\n\0" as *const u8 as *const libc::c_char,
        // );
    ...
    if g0.week >= 0 as libc::c_int {
        if timeoverwrite == 1 as libc::c_int {
            ...
            gtmp.week = g0.week;
            gtmp.sec = (g0.sec as libc::c_int / 7200 as libc::c_int) as libc::c_double * 7200.0f64;
            ...
            // fprintf(
            //     stderr,
            //     b"ERROR: Invalid start time.\n\0" as *const u8 as *const libc::c_char,
            // );
            // fprintf(
            //     stderr,
            //     b"tmin = %4d/%02d/%02d,%02d:%02d:%02.0f (%d:%.0f)\n\0" as *const u8
            //         as *const libc::c_char,
            //     tmin.y,
            //     tmin.m,
            //     tmin.d,
            ...
            // fprintf(
            //     stderr,
            //     b"tmax = %4d/%02d/%02d,%02d:%02d:%02.0f (%d:%.0f)\n\0" as *const u8
            //         as *const libc::c_char,
            //     tmax.y,
            //     tmax.m,
            //     tmax.d,
    ...
    // fprintf(
    //     stderr,
    //     b"Start time = %4d/%02d/%02d,%02d:%02d:%02.0f (%d:%.0f)\n\0" as *const u8
    //         as *const libc::c_char,
    //     t0.y,
    //     t0.m,
    //     t0.d,
    ...
    if ieph == -(1 as libc::c_int) {
        // fprintf(
        //     stderr,
        //     b"ERROR: No current set of ephemerides has been found.\n\0" as *const u8
        //         as *const libc::c_char,
        // );
    ...
    if iq_buff.is_null() {
        // fprintf(
        //     stderr,
        //     b"ERROR: Failed to allocate 16-bit I/Q buffer.\n\0" as *const u8 as *const libc::c_char,
        // );
    ...
    if data_format == 8 as libc::c_int {
        ...
        if iq8_buff.is_null() {
            // fprintf(
            //     stderr,
            //     b"ERROR: Failed to allocate 8-bit I/Q buffer.\n\0" as *const u8
            //         as *const libc::c_char,
            // );
        ...
        if iq8_buff.is_null() {
            // fprintf(
            //     stderr,
            //     b"ERROR: Failed to allocate compressed 1-bit I/Q buffer.\n\0" as *const u8
            //         as *const libc::c_char,
            // );
    ...
    ) != 0
    {
        ...
        if fp.is_null() {
            // fprintf(
            //     stderr,
            //     b"ERROR: Failed to open output file.\n\0" as *const u8 as *const libc::c_char,
            // );
    ...
    while iumd < numd {
        ...
        while i < 16 as libc::c_int {
            if chan[i as usize].prn > 0 as libc::c_int {
                ...
                chan[i as usize].carr_phasestep =
                    round(512.0f64 * 65536.0f64 * chan[i as usize].f_carr * delt) as libc::c_int;
                path_loss = 20200000.0f64 / rho.d;
                ibs = ((90.0f64 - rho.azel[1 as libc::c_int as usize] * 57.2957795131f64) / 5.0f64)
                    as libc::c_int;
        ...
        if data_format == 1 as libc::c_int {
            ...
            isamp = 0 as libc::c_int;
            while isamp < 2 as libc::c_int * iq_buff_size {
                *iq8_buff.offset(isamp as isize) = (*iq_buff.offset(isamp as isize) as libc::c_int
                    >> 4 as libc::c_int)
                    as libc::c_schar;
                isamp += 1;
                isamp;
        ...
        // fprintf(
        //     stderr,
        //     b"\rTime into run = %4.1f\0" as *const u8 as *const libc::c_char,
        //     subGpsTime(grx, g0),
        // );
